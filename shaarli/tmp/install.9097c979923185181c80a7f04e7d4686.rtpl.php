...
<html>
<head><?php $tpl = new RainTpl;$tpl_dir_temp = self::$tpl_dir;$tpl->assign( $this->var );$tpl->draw( dirname("includes") . ( substr("includes",-1,1) != "/" ? "/" : "" ) . basename("includes") );?><?php echo $timezone_js;?></head>
...
<form method="POST" action="" name="installform" id="installform" style="border:1px solid #dddddd; padding:10 10 10 10;">
